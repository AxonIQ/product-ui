<script lang="ts">
    import { Button, Typography } from '@axoniq-product-ui/core';
    ...
    <div class="footer__links">
        <div class="footer__links-content">
            <div class="footer__links-content-legal">
                ...
                <Typography size="s">Axon Reference Guide</Typography>
                <Typography size="s">AxonIQ Academy</Typography>
                <Typography size="s">AxonIQ Discuss</Typography>
                <Typography size="s">General Conditions</Typography>
                <Typography size="s">Privacy Policy</Typography>
            </div>
